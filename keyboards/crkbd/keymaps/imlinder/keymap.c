...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI,  LOWER, MSE_SPC,    NAV_BSPC,  RAISE , KC_RALT
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, XXXXXXX,                      XXXXXXX,  QWERTY,      SWE, XXXXXXX, XXXXXXX,QK_BOOT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
bool update_layer(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        case QWERTY:
...
void oled_render_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state|default_layer_state)) {
        case _QWERTY:
            ...
            break;
        case _SWE:
            oled_write_ln_P(PSTR("SWEDISH"), false);
            break;
        case _LOWER:
